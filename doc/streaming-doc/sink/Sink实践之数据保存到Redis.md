...
传送门：https://github.com/ash-ali/MyFlink-doc/blob/master/src/main/java/com/example/demo/streaming/sink/StreamingSinkToRedis.java
#### 通过FlinkJedisPoolConfig类设置相关参数来连接的Redis
...
- 第一个参数就是FlinkJedisPoolConfig
- 第二个参数需要实现RedisMapper(作用是从接收的数据中分别获得key与value)
```java
